        ...
        <div
            ...
            <form action="{{ route('vehiculos.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <!-- Panel Documentación -->
                    <div class="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-2xl shadow-inner space-y-6 transition-colors duration-300">
                        <h3 class="text-xl font-bold text-gray-700 dark:text-gray-100 mb-4">Documentación</h3>
                        <p class="text-gray-500 dark:text-gray-400 mb-4">
                            Selecciona el tipo de documento (Propiedad) y adjunta su tarjeta de propiedad en formato PDF o JPG.
                        </p>
                        <div>
                            <label class="block font-medium text-gray-700 dark:text-gray-200 mb-1">Tipo de documento</label>
                        ...
                        <!-- Input para archivo -->
                        <div>
                            <label class="block font-medium text-gray-700 dark:text-gray-200 mb-1">Adjuntar documento (PDF o JPG)</label>
